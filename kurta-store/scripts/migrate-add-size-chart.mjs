// One-shot additive schema sync: adds the sizeChartImageUrl column to
// products that drizzle's schema.ts defines but the live DB may be missing.
// Idempotent — safe to rerun.
// Usage: node scripts/migrate-add-size-chart.mjs
...
const NEW_COLUMNS = [
  { name: 'sizeChartImageUrl', ddl: 'varchar(500) NULL' },
];
